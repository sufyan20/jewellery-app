...
import { renderToString } from 'file://E:/jewelary-app/node_modules/vue/server-renderer/index.mjs';
import { klona } from 'file://E:/jewelary-app/node_modules/klona/dist/index.mjs';
import defu, { defuFn, defu as defu$1 } from 'file://E:/jewelary-app/node_modules/defu/dist/defu.mjs';
import destr, { destr as destr$1 } from 'file://E:/jewelary-app/node_modules/destr/dist/index.mjs';
import { snakeCase } from 'file://E:/jewelary-app/node_modules/scule/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file://E:/jewelary-app/node_modules/unhead/dist/server.mjs';
import { stringify, uneval } from 'file://E:/jewelary-app/node_modules/devalue/index.js';
import { isVNode, isRef, toValue } from 'file://E:/jewelary-app/node_modules/vue/index.mjs';
import { DeprecationsPlugin, PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file://E:/jewelary-app/node_modules/unhead/dist/plugins.mjs';
import { createHooks } from 'file://E:/jewelary-app/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file://E:/jewelary-app/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file://E:/jewelary-app/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://E:/jewelary-app/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://E:/jewelary-app/node_modules/unstorage/drivers/fs.mjs';
import { digest } from 'file://E:/jewelary-app/node_modules/ohash/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file://E:/jewelary-app/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file://E:/jewelary-app/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file://E:/jewelary-app/node_modules/youch-core/build/index.js';
import { Youch } from 'file://E:/jewelary-app/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file://E:/jewelary-app/node_modules/source-map/source-map.js';
...
const serverAssets = [{"baseName":"server","dir":"E:/jewelary-app/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"E:/jewelary-app","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"E:/jewelary-app/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"E:/jewelary-app/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"E:/jewelary-app/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"E:/jewelary-app/.data/kv"}));
...
const _YUczgxymFBMNJYOVYTn6AmRVoXsFb02BS_CYBTOPSOk = (function(nitro) {
...
const _VycZrzKrZoiFO2f6u_bzaWXsW2SEy8Xz9WPxZPMEvF8 = (nitroApp) => {
...
const plugins = [
  _YUczgxymFBMNJYOVYTn6AmRVoXsFb02BS_CYBTOPSOk,
...
const _cVb9pE = eventHandler((event) => {
...
const getServerEntry = () => import('file://E:/jewelary-app/.nuxt//dist/server/server.mjs').then((r) => r.default || r);
// @ts-expect-error file will be produced after app build
const getClientManifest = () => import('file://E:/jewelary-app/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
// -- SSR Renderer --
...
const _sNlyHfMeta = null;

const _D0W7R5Meta = null;
...
{ route: "/_openapi.json", method: undefined, meta: _sNlyHfMeta },
{ route: "/_scalar", method: undefined, meta: _D0W7R5Meta },
{ route: "/_swagger", method: undefined, meta: _toJP4_Meta }
  ];

const _sNlyHf = eventHandler((event) => {
...
const _D0W7R5 = eventHandler((event) => {
  const runtimeConfig = useRuntimeConfig(event);
...
const _toJP4_ = eventHandler((event) => {
  const runtimeConfig = useRuntimeConfig(event);
  const title = runtimeConfig.nitro.openAPI?.meta?.title || "API Reference";
  const description = runtimeConfig.nitro.openAPI?.meta?.description || "";
  const openAPIEndpoint = runtimeConfig.nitro.openAPI?.route || "./_openapi.json";
...
const handlers = [
  ...
  { route: '/_openapi.json', handler: _sNlyHf, lazy: false, middleware: false, method: undefined },
  { route: '/_scalar', handler: _D0W7R5, lazy: false, middleware: false, method: undefined },
  { route: '/_swagger', handler: _toJP4_, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_CMMjDo, lazy: true, middleware: false, method: undefined }
];
  ...
  try {
    const calculation = await prisma$1.calculation.create({
      data: {
        ...
        notes: notes || "",
        motiRequirements: {
          create: (motiRequirements || []).map((moti) => ({
